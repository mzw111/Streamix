...
try:
    ...
    # Apply profile limit trigger
    print("\n" + "=" * 60)
    print("APPLYING PROFILE LIMIT TRIGGER")
    print("=" * 60)
    ...
    try:
        ...
        print(f'⚠️  Warning: Could not create trigger: {trigger_error}')
        print('   Note: Trigger may already exist in database_objects.sql')
